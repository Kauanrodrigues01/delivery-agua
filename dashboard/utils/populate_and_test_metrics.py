...
def populate_database():
    ...
    # Criar pedidos
    order1 = Order.objects.create(customer_name="Cliente 1", phone="123456789", address="Endereço 1", status="completed")
    order2 = Order.objects.create(customer_name="Cliente 2", phone="987654321", address="Endereço 2", status="completed")
...
def test_metrics():
    ...
    assert calculated == expected, f"Metrics do not match!\nCalculated: {calculated}\nExpected: {expected}"
